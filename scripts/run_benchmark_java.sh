...
cd $contract_dir && mvn install

### cd $contract_dir/lib && node generator.js
### cp $contract_dir/lib/seeds.json $benchmark_dir/
### cd $benchmark_dir && npm install
# mozda upotrebiti gornju liniju, a generator premestiti u benchmark i samo setovati i node uz javu
# mada node svakako i treba zbog benchmark
